...
public class exerc5 {
	public static void main(String[] args) {
		...
		ohara.listarLivros();
		ohara.removerLivro("One Piece");
		System.out.println("Após remover One Piece:");
		ohara.listarLivros();
		
		System.out.println("Livros de Rj palacio:");
		List<Livro>livrosRJ=ohara.buscarPorAutor("RJ palacio");
		for(Livro livro : livrosRJ) {
			System.out.println(livro);
		}
